...
MODELO_EMBEDDING = OpenAIEmbeddings(model=os.getenv("EMBEDDING_MODELO", ""), api_key=OPENAI_API)

TOP_K = int(os.getenv("TOP_K", "15"))


AZURE_SQL_SERVER = os.getenv("AZURE_SQL_SERVER")
AZURE_SQL_SERVER_DATABASE = os.getenv("AZURE_SQL_SERVER_DATABASE")
AZURE_SQL_SERVER_USERNAME = os.getenv("AZURE_SQL_SERVER_USERNAME")
AZURE_SQL_SERVER_PASSWORD = os.getenv("AZURE_SQL_SERVER_PASSWORD")